...
export class MockIndividualInformationFormClass extends MockAction {
	name(): string {
		return "individual_information_form";
	}
	get description(): string {
	console.log("hereee, Mock for individual_information_form")
		return "Mock for individual_information_form";
	}
	...
	async validate(
		...
		const formLink = sessionData["individual_information_form"];
		if (!formLink) {
	...
	override async __forceSaveData(
		...
		return {
			...sessionData,
			individual_information_form: resolveFormActions(formLink, formData),
		};
	}
	...
	get saveData(): saveType {
		return { "save-data": { individual_information_form: "individual_information_form" } };
	}
	get defaultData(): any {
		return {};
	}
