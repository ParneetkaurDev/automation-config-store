...
import { on_init_redemptionDefaultGenerator } from "./generator";

export class MockOnInitRedemptionClass extends MockAction {
  ...
  async generator(existingPayload: any, sessionData: any): Promise<any> {
    return on_init_redemptionDefaultGenerator(existingPayload, sessionData);
  }
