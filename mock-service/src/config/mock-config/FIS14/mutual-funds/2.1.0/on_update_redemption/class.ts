...
import { on_update_redemptionDefaultGenerator } from "./generator";

export class MockOnUpdateRedemptionClass extends MockAction {
  ...
  async generator(existingPayload: any, sessionData: any): Promise<any> {
    return on_update_redemptionDefaultGenerator(existingPayload, sessionData);
  }
