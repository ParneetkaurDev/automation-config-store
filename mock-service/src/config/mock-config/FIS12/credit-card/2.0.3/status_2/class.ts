...
export class MockStatus2CCClass extends MockAction {
    ...
    name(): string { return "status_1_personal_loan"; }
    get description(): string { return "Mock for status_1 personal loan"; }
