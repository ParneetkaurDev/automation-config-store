...
export class MockSelectCCClass extends MockAction {
    ...
    name(): string { return "select_1_personal_loan"; }
    get description(): string { return "Mock for select_1 personal loan"; }
