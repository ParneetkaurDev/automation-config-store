...
export class MockOnSelectCCClass extends MockAction {
    ...
    name(): string { return "on_select_2_personal_loan"; }
    get description(): string { return "Mock for on_select_2 personal loan"; }
