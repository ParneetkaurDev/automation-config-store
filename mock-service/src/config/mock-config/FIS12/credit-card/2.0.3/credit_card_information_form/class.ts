...
export class MockCreditcardInformationClass extends MockAction {
	name(): string {
		return "credit_card_information_form";
	}
	get description(): string {
		return "Mock for credit_card_information_form";
	}
	...
	async validate(
		...
		const formLink = sessionData["credit_card_information_form"];
		if (!formLink) {
	...
	override async __forceSaveData(
		...
		return {
			...sessionData,
			credit_card_information_form: resolveFormActions(formLink, formData),
		};
	}
	...
	get saveData(): saveType {
		return { "save-data": { credit_card_information_form: "credit_card_information_form" } };
