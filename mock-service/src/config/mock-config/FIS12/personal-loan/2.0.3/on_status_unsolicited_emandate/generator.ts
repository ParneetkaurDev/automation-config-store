...
export async function onStatusUnsolicitedEmandateGenerator(existingPayload: any, sessionData: any) {
    if (existingPayload.context) {
        existingPayload.context.timestamp = new Date().toISOString();
    }

    console.log("sessionData for on_status_unsolicited_emandate", sessionData);
    ...
    if (existingPayload.context) {
        ...
        console.log("Generated new message_id for unsolicited on_status (emandate):", existingPayload.context.message_id);
    }
