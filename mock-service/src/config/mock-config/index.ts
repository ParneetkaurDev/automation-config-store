...
export function getUiMetaKeys(): (keyof MockSessionData)[] {
	return ["verification_status", "Ekyc_details_form", "Ekyc_details_form_cc", "payment_url_form", "consumer_information_form", "personal_loan_information_form", "loan_amount_adjustment_form", "manadate_details_form", "loan_agreement_esign_form", "credit_card_information_form"];
}