...
export function getUiMetaKeys(): (keyof MockSessionData)[] {
	return ["investor_details_form", "E_sign_verification_status", "kyc_details_form", "retry_payment_url_form", "payment_url_form", "verification_status", "E_sign_verification_status", "payment_mandate_form"];
}